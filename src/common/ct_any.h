 ...
 */
COTER_API bool ct_any_isvalid(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 字符串长度
 */
COTER_API size_t ct_any_tostring(const ct_any_buf_t self, char *buf, size_t max) __ct_func_throw __ct_nonnull(1);
 ...
 */
COTER_API int ct_any_compare(const ct_any_buf_t l, const ct_any_buf_t r) __ct_func_throw __ct_nonnull(1);
 ...
 * @param r 右操作数
 */
COTER_API void ct_any_swap(ct_any_buf_t l, ct_any_buf_t r) __ct_func_throw __ct_nonnull(1);
 ...
 */
COTER_API void ct_any_copy(ct_any_buf_t self, const ct_any_buf_t other) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 数据类型
 */
COTER_API ct_any_type_t ct_any_type(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 布尔值
 */
COTER_API void ct_any_set_bool(ct_any_buf_t self, bool value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 浮点值
 */
COTER_API void ct_any_set_float(ct_any_buf_t self, float value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 双精度浮点值
 */
COTER_API void ct_any_set_double(ct_any_buf_t self, double value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 字符串值
 */
COTER_API void ct_any_set_string(ct_any_buf_t self, const char *value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 指针值
 */
COTER_API void ct_any_set_pointer(ct_any_buf_t self, void *value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 整型值
 */
COTER_API void ct_any_set_int(ct_any_buf_t self, int value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 8位整型值
 */
COTER_API void ct_any_set_int8(ct_any_buf_t self, int8_t value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 16位整型值
 */
COTER_API void ct_any_set_int16(ct_any_buf_t self, int16_t value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 32位整型值
 */
COTER_API void ct_any_set_int32(ct_any_buf_t self, int32_t value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 64位整型值
 */
COTER_API void ct_any_set_int64(ct_any_buf_t self, int64_t value) __ct_func_throw __ct_nonnull(1);
 ...
 * @param value 无符号整型值
 */
COTER_API void ct_any_set_uint(ct_any_buf_t self, unsigned value) __ct_func_throw __ct_nonnull(1);
 ...
 */
COTER_API void ct_any_set_uint8(ct_any_buf_t self, uint8_t value) __ct_func_throw __ct_nonnull(1);
 ...
 */
COTER_API void ct_any_set_uint16(ct_any_buf_t self, uint16_t value) __ct_func_throw __ct_nonnull(1);
 ...
 */
COTER_API void ct_any_set_uint32(ct_any_buf_t self, uint32_t value) __ct_func_throw __ct_nonnull(1);
 ...
 */
COTER_API void ct_any_set_uint64(ct_any_buf_t self, uint64_t value) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 布尔值
 */
COTER_API bool ct_any_get_bool(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 浮点值
 */
COTER_API float ct_any_get_float(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 双精度浮点值
 */
COTER_API double ct_any_get_double(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 字符串值
 */
COTER_API const char *ct_any_get_string(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 指针值
 */
COTER_API void *ct_any_get_pointer(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 整型值
 */
COTER_API int ct_any_get_int(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 8位整型值
 */
COTER_API int8_t ct_any_get_int8(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 16位整型值
 */
COTER_API int16_t ct_any_get_int16(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 32位整型值
 */
COTER_API int32_t ct_any_get_int32(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 64位整型值
 */
COTER_API int64_t ct_any_get_int64(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 无符号整型值
 */
COTER_API unsigned ct_any_get_uint(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 8位无符号整型值
 */
COTER_API uint8_t ct_any_get_uint8(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 16位无符号整型值
 */
COTER_API uint16_t ct_any_get_uint16(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 32位无符号整型值
 */
COTER_API uint32_t ct_any_get_uint32(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
 ...
 * @return 64位无符号整型值
 */
COTER_API uint64_t ct_any_get_uint64(const ct_any_buf_t self) __ct_func_throw __ct_nonnull(1);
