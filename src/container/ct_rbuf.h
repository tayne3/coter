 ...
 * @param max 缓冲区大小
 */
CT_API void ct_rbuf_init(ct_rbuf_buf_t self, void *buffer, size_t byte, size_t max);
 ...
 */
CT_API bool ct_rbuf_put(ct_rbuf_buf_t self, const void *item);
 ...
 * @return 成功返回 true，失败返回 false
 */
CT_API bool ct_rbuf_take(ct_rbuf_buf_t self, void *item);
 ...
 */
CT_API size_t ct_rbuf_puts(ct_rbuf_buf_t self, const void *items, size_t size);
 ...
 * @return 成功获取的元素数量
 */
CT_API size_t ct_rbuf_takes(ct_rbuf_buf_t self, void *items, size_t size);
 ...
 */
CT_API size_t ct_rbuf_gets(ct_rbuf_buf_t self, void *items, size_t size);
 ...
 */
CT_API size_t ct_rbuf_remove(ct_rbuf_buf_t self, size_t size);
 ...
 */
CT_API void *ct_rbuf_items(const ct_rbuf_buf_t self, size_t offset, size_t size[1]);
