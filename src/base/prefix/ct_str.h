 ...
 */
COTER_API char *ct_strcat(char *__dest, const char *__src) __ct_func_throw __ct_nonnull(1, 2);
 ...
 * @return 指向连接后的目标字符串的指针
 */
COTER_API char *ct_strncat(char *__dest, const char *__src, size_t __n) __ct_func_throw __ct_nonnull(1, 2);
 ...
 * @return 复制后的字符串
 */
COTER_API char *ct_strcpy(char *__dest, const char *__src) __ct_func_throw __ct_nonnull(1, 2);
 ...
 * @return 复制后的字符串
 */
COTER_API char *ct_strncpy(char *__dest, const char *__src, size_t __n) __ct_func_throw __ct_nonnull(1, 2);
 ...
 */
COTER_API int ct_strcmp(const char *l, const char *r) __ct_func_throw __ct_func_pure__;
 ...
 */
COTER_API int ct_strncmp(const char *l, const char *r, size_t n) __ct_func_throw __ct_func_pure__;
 ...
 */
COTER_API int ct_strcasecmp(const char *l, const char *r) __ct_func_throw __ct_func_pure__;
 ...
 */
COTER_API int ct_strncasecmp(const char *l, const char *r, size_t n) __ct_func_throw __ct_func_pure__;
 ...
 * @return 格式化后的字符串的长度
 */
COTER_API int ct_sprintf(char *__restrict __s, const char *__restrict __format, ...) __ct_func_throw;
 ...
 */
COTER_API int ct_snprintf(char *__restrict __s, size_t __maxlen, const char *__restrict __format, ...) __ct_func_throw
