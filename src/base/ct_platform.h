 ...
 * @return 字符串的长度
 */
size_t ct_strlen(const char *__s) __ct_func_throw __ct_func_pure__ __ct_nonnull(1);
 ...
 */
const char *ct_strchr(const char *__s, int __c) __ct_func_throw __ct_func_pure__ __ct_nonnull(1);
 ...
 */
const char *ct_strrchr(const char *__s, int __c) __ct_func_throw __ct_func_pure__ __ct_nonnull(1);
 ...
 */
const char *ct_strstr(const char *__haystack, const char *__needle) __ct_func_throw __ct_func_pure__ __ct_nonnull(1, 2);
