...
TEST_CASE("computes next minutely timeout" * doctest::test_suite("cron_next")) {
...
TEST_CASE("computes next hourly timeout" * doctest::test_suite("cron_next")) {
    const ct_time_t before   = create_test_time(2000, 1, 1, 0, 0, 0);
...
TEST_CASE("computes next daily timeout" * doctest::test_suite("cron_next")) {
    const ct_time_t before   = create_test_time(2000, 1, 1, 0, 0, 0);
...
TEST_CASE("computes next weekly timeout" * doctest::test_suite("cron_next")) {
    const ct_time_t before   = create_test_time(2000, 1, 1, 0, 0, 0);
    const ct_time_t expected = create_test_time(2000, 1, 2, 0, 0, 0);
...
TEST_CASE("computes next monthly timeout" * doctest::test_suite("cron_next")) {
    const ct_time_t before   = create_test_time(2000, 1, 1, 0, 0, 0);
...
TEST_CASE("computes next yearly timeout" * doctest::test_suite("cron_next")) {
    const ct_time_t before   = create_test_time(2000, 1, 1, 0, 0, 0);
...
TEST_CASE("returns -1 for invalid parameters" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles month boundary correctly" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles year boundary correctly" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles leap year correctly" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles non-leap year correctly" * doctest::test_suite("cron_next")) {
...
TEST_CASE("skips months without day 31" * doctest::test_suite("cron_next")) {
...
TEST_CASE("skips months without day 30" * doctest::test_suite("cron_next")) {
...
TEST_CASE("skips multiple months when day doesn't exist" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles weekly schedule crossing month boundary" * doctest::test_suite("cron_next")) {
    const ct_time_t before   = create_test_time(2023, 1, 30, 0, 0, 0);
...
TEST_CASE("handles weekly schedule crossing year boundary" * doctest::test_suite("cron_next")) {
...
TEST_CASE("advances to next day when time has passed" * doctest::test_suite("cron_next")) {
...
TEST_CASE("advances to next month when day has passed" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles complex monthly schedule with specific time" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles complex yearly schedule with specific time" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles yearly schedule in leap year" * doctest::test_suite("cron_next")) {
...
TEST_CASE("handles maximum day boundary" * doctest::test_suite("cron_next")) {
...
TEST_CASE("advances to next year when month has passed" * doctest::test_suite("cron_next")) {
...
TEST_CASE("computes weekly schedule with specific day" * doctest::test_suite("cron_next")) {
