...
TEST_CASE("utils.bcd_conversion.u8", "[bcd][u8]") {
...
TEST_CASE("utils.bcd_conversion.u16", "[bcd][u16]") {
...
TEST_CASE("utils.bcd_conversion.u32", "[bcd][u32]") {
...
TEST_CASE("utils.bcd_conversion.u64", "[bcd][u64]") {
