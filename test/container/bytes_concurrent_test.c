...
static void test_bytes_concurrent(void) {
	...
	ctunit_assert_uint32_equal(filled_pool.total_chunks, expected_chunks);
	ctunit_assert_uint32_equal(free_pool.total_chunks, expected_chunks);
}
