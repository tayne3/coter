 ...
 * @endcode
 */
void ct_random_init(ct_random_buf_t self) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
bool ct_random_bool(ct_random_buf_t self) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
uint8_t ct_random_uint8(ct_random_buf_t self, uint8_t min, uint8_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
int8_t ct_random_int8(ct_random_buf_t self, int8_t min, int8_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
uint16_t ct_random_uint16(ct_random_buf_t self, uint16_t min, uint16_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
int16_t ct_random_int16(ct_random_buf_t self, int16_t min, int16_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
uint32_t ct_random_uint32(ct_random_buf_t self, uint32_t min, uint32_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
int32_t ct_random_int32(ct_random_buf_t self, int32_t min, int32_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
uint64_t ct_random_uint64(ct_random_buf_t self, uint64_t min, uint64_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
int64_t ct_random_int64(ct_random_buf_t self, int64_t min, int64_t max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
float ct_random_float(ct_random_buf_t self, float min, float max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
double ct_random_double(ct_random_buf_t self, double min, double max) __ct_throw __ct_nonnull(1);
 ...
 * @endcode
 */
void ct_random_string(ct_random_buf_t self, char* str, size_t length) __ct_throw __ct_nonnull(1, 2);
