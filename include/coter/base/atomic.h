...
#define ct_atomic_load(p)     atomic_load(p)
#define ct_atomic_store(p, v) atomic_store(p, v)
#define ct_atomic_add(p, n)   atomic_fetch_add(p, n)
#define ct_atomic_sub(p, n)   atomic_fetch_sub(p, n)
#define ct_atomic_inc(p)      ct_atomic_add(p, 1)
#define ct_atomic_dec(p)      ct_atomic_sub(p, 1)
...
#define ct_atomic_add(p, n)   InterlockedExchangeAdd(p, n)
...
#define ct_atomic_add(p, n)   __sync_fetch_and_add(p, n)
#define ct_atomic_sub(p, n)   __sync_fetch_and_sub(p, n)
#define ct_atomic_inc(p)      CT_ATOMIC_ADD(p, 1)
#define ct_atomic_dec(p)      CT_ATOMIC_SUB(p, 1)
