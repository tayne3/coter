 ...
 * @param max 缓冲区大小
 */
void ct_queue_init(ct_queue_buf_t self, void* buffer, size_t byte, size_t max) __ct_nonnull(1, 2);
 ...
 * @return 队列状态
 */
bool ct_queue_enqueue(ct_queue_buf_t self, const void* item) __ct_nonnull(1, 2);
 ...
 */
bool ct_queue_dequeue(ct_queue_buf_t self, void* item) __ct_nonnull(1, 2);
 ...
 * @return 成功返回 true，失败返回 false
 */
bool ct_queue_head(ct_queue_buf_t self, void* item) __ct_nonnull(1, 2);
