 ...
 * @param max 缓冲区大小
 */
void ct_rbuf_init(ct_rbuf_buf_t self, void *buffer, size_t byte, size_t max) __ct_nonnull(1, 2);
 ...
 */
bool ct_rbuf_put(ct_rbuf_buf_t self, const void *item) __ct_nonnull(1);
 ...
 * @return 成功返回 true，失败返回 false
 */
bool ct_rbuf_take(ct_rbuf_buf_t self, void *item) __ct_nonnull(1);
 ...
 */
size_t ct_rbuf_puts(ct_rbuf_buf_t self, const void *items, size_t size) __ct_nonnull(1);
 ...
 * @return 成功获取的元素数量
 */
size_t ct_rbuf_takes(ct_rbuf_buf_t self, void *items, size_t size) __ct_nonnull(1);
 ...
 */
size_t ct_rbuf_gets(ct_rbuf_buf_t self, void *items, size_t size) __ct_nonnull(1);
 ...
 */
size_t ct_rbuf_remove(ct_rbuf_buf_t self, size_t size) __ct_nonnull(1);
 ...
 */
void *ct_rbuf_items(const ct_rbuf_buf_t self, size_t offset, size_t size[1]) __ct_nonnull(1);
