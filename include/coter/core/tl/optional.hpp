...
// in some cases. This is a check to workaround the common failing case.
	...
	struct optional_storage_base {
		...
		template <class... U>
		TL_OPTIONAL_11_CONSTEXPR optional_storage_base(in_place_t, U &&...u) : m_value(std::forward<U>(u)...), m_has_value(true) {}
...
// move constructible
	...
	template <class T,
			  bool = TL_OPTIONAL_IS_TRIVIALLY_COPY_ASSIGNABLE(T) && TL_OPTIONAL_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T) && TL_OPTIONAL_IS_TRIVIALLY_DESTRUCTIBLE(T)>
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0826r0.html
	...
	TL_OPTIONAL_11_CONSTEXPR explicit optional(detail::enable_if_t<std::is_constructible<T, std::initializer_list<U> &, Args &&...>::value, in_place_t>,
