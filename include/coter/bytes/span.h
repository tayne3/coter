#ifndef COTER_BYTES_SPAN_H
#define COTER_BYTES_SPAN_H
...
#define ct_span_capacity(self)   ((size_t)(self)->cap)
#define ct_span_count(self)      ((size_t)(self)->len)
#define ct_span_pos(self)        ((size_t)(self)->pos)
#define ct_span_readable(self)   ((size_t)((self)->len - (self)->pos))
#define ct_span_writable(self)   ((size_t)((self)->cap - (self)->pos))
#define ct_span_appendable(self) ((size_t)((self)->cap - (self)->len))
#define ct_span_is_empty(self)   ((self)->len == 0U)
#define ct_span_is_full(self)    ((self)->len == (self)->cap)
#define ct_span_data(self)       ((self)->bytes)

#define ct_span_get_endian(self)    ((self)->endian)
#define ct_span_set_endian(self, e) ((self)->endian = (e))
#define ct_span_get_hlswap(self)    ((self)->hlswap)
#define ct_span_set_hlswap(self, h) ((self)->hlswap = (h))
#define ct_span_rewind(self)        ((self)->pos = 0U)
#define ct_span_clear(self)         ((self)->len = (self)->pos = 0U)
 ...
 */
static inline void ct_span_init(ct_span_t *self, uint8_t *bytes, size_t cap) {
	self->bytes  = bytes;
...
static inline int ct_span_seek(ct_span_t *self, size_t offset) {
...
static inline int ct_span_reseek(ct_span_t *self, size_t offset) {
	if (self->len < (uint32_t)offset) {
		return -1;
	}
...
static inline int ct_span_skip(ct_span_t *self, size_t length) {
...
static inline int ct_span_commit(ct_span_t *self, size_t length) {
...
static inline int ct_span_since(ct_span_t *self, ct_span_t *since, size_t start, size_t end) {
...
#define ct_span_readable_since(self, since) ct_span_since((self), (since), (self)->pos, (self)->len);
