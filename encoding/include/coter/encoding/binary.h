 ...
 */
CT_API extern const ct_binary_order_t ct_little_endian;

/**
 * @brief Big-endian byte order instance.
 * @example 0x12345678 → {0x12, 0x34, 0x56, 0x78}
 */
CT_API extern const ct_binary_order_t ct_big_endian;
 ...
 */
CT_INLINE uint32_t ct_binary_bswap16_x2(uint32_t val) {
 ...
 */
CT_INLINE uint64_t ct_binary_bswap16_x4(uint64_t val) {
 ...
 */
CT_INLINE uint32_t ct_binary_reverse_words32(uint32_t val) {
 ...
 */
CT_INLINE uint64_t ct_binary_reverse_words64(uint64_t val) {
 ...
 */
CT_INLINE uint16_t ct_little_get_uint16(const uint8_t* buf) {
    uint16_t val;
 ...
 */
CT_INLINE uint32_t ct_little_get_uint32(const uint8_t* buf) {
    uint32_t val;
    memcpy(&val, buf, sizeof(val));
#if CT_ENDIAN_IS_LITTLE
    return val;
 ...
 */
CT_INLINE uint64_t ct_little_get_uint64(const uint8_t* buf) {
    uint64_t val;
    memcpy(&val, buf, sizeof(val));
#if CT_ENDIAN_IS_LITTLE
    return val;
 ...
 */
CT_INLINE void ct_little_put_uint16(uint8_t* buf, uint16_t val) {
#if CT_ENDIAN_IS_BIG
 ...
 */
CT_INLINE void ct_little_put_uint32(uint8_t* buf, uint32_t val) {
#if CT_ENDIAN_IS_BIG
 ...
 */
CT_INLINE void ct_little_put_uint64(uint8_t* buf, uint64_t val) {
#if CT_ENDIAN_IS_BIG
 ...
 */
CT_INLINE uint16_t ct_big_get_uint16(const uint8_t* buf) {
    uint16_t val;
    memcpy(&val, buf, sizeof(val));
#if CT_ENDIAN_IS_BIG
    return val;
 ...
 */
CT_INLINE uint32_t ct_big_get_uint32(const uint8_t* buf) {
    uint32_t val;
    memcpy(&val, buf, sizeof(val));
#if CT_ENDIAN_IS_BIG
    return val;
 ...
 */
CT_INLINE uint64_t ct_big_get_uint64(const uint8_t* buf) {
    uint64_t val;
    memcpy(&val, buf, sizeof(val));
#if CT_ENDIAN_IS_BIG
    return val;
 ...
 */
CT_INLINE void ct_big_put_uint16(uint8_t* buf, uint16_t val) {
#if CT_ENDIAN_IS_LITTLE
    val = ct_binary_bswap16(val);
#endif
    memcpy(buf, &val, sizeof(val));
 ...
 */
CT_INLINE void ct_big_put_uint32(uint8_t* buf, uint32_t val) {
#if CT_ENDIAN_IS_LITTLE
    val = ct_binary_bswap32(val);
#endif
    memcpy(buf, &val, sizeof(val));
 ...
 */
CT_INLINE void ct_big_put_uint64(uint8_t* buf, uint64_t val) {
#if CT_ENDIAN_IS_LITTLE
    val = ct_binary_bswap64(val);
#endif
    memcpy(buf, &val, sizeof(val));
 ...
 */
CT_API void ct_binary_bswap16_x2_batch(uint32_t* data, size_t count);

/**
 * @brief Swaps 16-bit pairs within each element of a uint64 array in place.
 */
CT_API void ct_binary_bswap16_x4_batch(uint64_t* data, size_t count);

/**
 * @brief Reverses bytes in each 16-bit word of a uint32 array in place.
 */
CT_API void ct_binary_reverse_words32_batch(uint32_t* data, size_t count);

/**
 * @brief Reverses bytes in each 16-bit word of a uint64 array in place.
 */
CT_API void ct_binary_reverse_words64_batch(uint64_t* data, size_t count);
