...
if(COTER_ENABLE_LTO)
  ...
  if(_lto_supported)
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      check_cxx_compiler_flag("-flto=auto" _has_cxx_lto_auto)
      if(_has_cxx_lto_auto)
        target_compile_options(coter_internal_options INTERFACE $<$<NOT:$<CONFIG:Debug>>:-flto=auto -fuse-linker-plugin>)
        target_link_options(coter_internal_options INTERFACE $<$<NOT:$<CONFIG:Debug>>:-flto=auto>)
      else()
        target_compile_options(coter_internal_options INTERFACE $<$<NOT:$<CONFIG:Debug>>:-flto -fuse-linker-plugin>)
        target_link_options(coter_internal_options INTERFACE $<$<NOT:$<CONFIG:Debug>>:-flto>)
      endif()
