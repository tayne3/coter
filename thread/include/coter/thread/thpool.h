 ...
 * @param self 线程池指针
 */
CT_API void ct_thpool_close(ct_thpool_t* self);
 ...
 * @param self 线程池指针
 */
CT_API void ct_thpool_destroy(ct_thpool_t* self);
 ...
 * @return 0=成功; 非0=失败
 */
CT_API int ct_thpool_submit(ct_thpool_t* self, ct_thpool_routine_t routine, void* arg);
