 ...
 */
static bool storage_file_init(ct_log_storage_t* self);
 ...
 */
static bool storage_file_next(ct_log_storage_t* self);
 ...
 * @return bool 是否创建成功
 */
static bool storage_folder_create_recursive(const char* path);
 ...
 * @return bool 是否设置成功
 */
static bool storage_file_writable_set(const char* filename);
