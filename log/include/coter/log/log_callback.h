 ...
 * @param self 日志回调器
 */
CT_API void ct_log_callback_destroy(ct_log_callback_t* self);
 ...
 * @param bytes 字节数组
 */
CT_API void ct_log_callback_handle(ct_log_callback_t* self, const char* buf, size_t size);
 ...
 * @param self 日志回调器
 */
CT_API void ct_log_callback_flush(ct_log_callback_t* self);
 ...
 * @param self 日志回调器
 */
CT_API void ct_log_callback_schedule(ct_log_callback_t* self);
