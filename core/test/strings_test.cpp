...
TEST_CASE("strings_snprintf_s" * doctest::test_suite("strings")) {
    ...
    REQUIRE(strcmp(buf, "-1 2 3.140000 test") == 0);
    REQUIRE(len == 18);
...
TEST_CASE("strings_reverse_memcpy_basic" * doctest::test_suite("strings")) {
    {
        ...
        REQUIRE(strcmp(dest, "!dlroW ,olleH") == 0);
    }
    {
        char src[]    = "Hello, World!";
        char dest[20] = "Initial Data";
        REQUIRE(ct_reverse_memcpy(dest, src, 0) == dest);
        REQUIRE(strcmp(dest, "Initial Data") == 0);
    }
    {
